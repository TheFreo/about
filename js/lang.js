let arrLang = {
    'ru': {
        ...
        'about': 'Обо мне',
        'welup': 'Я TheFreo,',
        'welun': ' Я начинающий программист. Люблю сидеть дома и смотреть аниме :-) Сейчас изучаю C++ и JavaScript.',
        'bio': 'Кто я?',
        'skills': 'Навыки',
        'devices': 'Девайсы',
        'pc': 'Основной ПК',
    ...
    'en': {
        ...
        'about': 'About me',
        'welup': "I'm TheFreo,",
        'welun': "I'm an aspiring programmer. I like to sit at home and watch anime :-) At the moment I am studying C++ and JavaScript.",
        'bio': 'Who Am I?',
        'skills': 'Skills',
        'devices': 'Devices',
        'pc': 'Main PC',
